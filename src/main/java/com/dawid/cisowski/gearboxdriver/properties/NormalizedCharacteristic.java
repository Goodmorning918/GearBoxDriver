...
public class NormalizedCharacteristic {
  ...
  public final double ECO_RPM_TO_REDUCE_GEAR_FOR_BREAKING = 1500;
  ...
  public final double COMFORT_RPM_TO_REDUCE_GEAR_FOR_BREAKING = 2000;
  ...
  public final double SPORT_RPM_TO_REDUCE_GEAR_FOR_BREAKING = 3000;
}
